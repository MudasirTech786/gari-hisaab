  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-zinc-400">Manage customer subscription billing and renewals.</p>
      </div>
      <div className="flex flex-col items-center justify-center rounded-2xl border border-white/[.07] bg-white/[.03] py-20">
        <CreditCard className="size-12 text-zinc-600 mb-4" />
        <p className="text-lg font-medium text-zinc-400">Coming Soon</p>
        <p className="text-sm text-zinc-600 mt-1">Subscription management will be available here.</p>
      </div>
    </div>
  )
}
